...
def import_runs_dataframe(rows: list[dict]) -> pd.DataFrame:
    ...
    renamed = df.rename(
        columns={
            ...
            "teachers_with_publications": "Викладачів з публікаціями",
            "source_records_found": "Виявлено записів",
            "matched_candidates_found": "Зіставлено кандидатів",
            "unique_publications_built": "Сформовано публікацій",
            "publications_found": "Завантажено публікацій",
    ...
    return renamed[
        [
            ...
            "Викладачів з публікаціями",
            "Виявлено записів",
            "Зіставлено кандидатів",
            "Сформовано публікацій",
