...
class Neo4jService:
    ...
    def complete_import_run(
        ...
        *,
        ...
        source_records_found: int = 0,
        matched_candidates_found: int = 0,
        unique_publications_built: int = 0,
        ...
        rows = self.run_query(
            ...
            SET
                ...
                r.source_records_found = $source_records_found,
                r.matched_candidates_found = $matched_candidates_found,
                r.unique_publications_built = $unique_publications_built,
            ...
            """,
            {
                ...
                "source_records_found": max(int(source_records_found or 0), 0),
                "matched_candidates_found": max(int(matched_candidates_found or 0), 0),
                "unique_publications_built": max(int(unique_publications_built or 0), 0),
    ...
    def get_import_runs(self, limit: int = 40) -> list[dict[str, Any]]:
        return self.run_query(
            ...
            RETURN
                ...
                coalesce(r.source_records_found, 0) AS source_records_found,
                coalesce(r.matched_candidates_found, 0) AS matched_candidates_found,
                coalesce(r.unique_publications_built, 0) AS unique_publications_built,
